...
o/srcs/ft_subisint.o: srcs/ft_subisint.c include/lem_in.h include/parser.h
	@mkdir -p o/srcs 2> /dev/null || true
	@$(MSG_0) $< ; clang $(C_FLAGS) $(C_HEADS) -c -o $@ $< || ($(MSG_1) $< && false)
...
o/srcs/ft_subdup.o: srcs/ft_subdup.c include/lem_in.h include/parser.h include/solver.h
	@mkdir -p o/srcs 2> /dev/null || true
	@$(MSG_0) $< ; clang $(C_FLAGS) $(C_HEADS) -c -o $@ $< || ($(MSG_1) $< && false)

o/srcs/utils.o: srcs/utils.c include/lem_in.h include/parser.h include/solver.h
	@mkdir -p o/srcs 2> /dev/null || true
	@$(MSG_0) $< ; clang $(C_FLAGS) $(C_HEADS) -c -o $@ $< || ($(MSG_1) $< && false)
...
o/srcs/ft_subtoi.o: srcs/ft_subtoi.c include/lem_in.h include/parser.h include/solver.h
	@mkdir -p o/srcs 2> /dev/null || true
	@$(MSG_0) $< ; clang $(C_FLAGS) $(C_HEADS) -c -o $@ $< || ($(MSG_1) $< && false)
